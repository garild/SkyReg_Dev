...
OutputDir=E:\GitRepositry\SkyReg_Dev\SkyReg\SkyReg\Instalator
OutputBaseFilename=SkyReg
SetupIconFile=E:\GitRepositry\SkyReg_Dev\SkyReg\SkyReg\Instalator\SkyReg.ico
...
[Icons]
Name: {group}\SkyReg; Filename: {app}\SkyReg.exe; IconIndex: 0; WorkingDir: {app}; IconFilename: {app}\EMnet.exe
