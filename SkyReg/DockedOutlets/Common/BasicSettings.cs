...
namespace DockedOutlets.Common
{
    public class BasicSettings
    {
        ...
        public Padding HeaderTitlePadding { get; set; } = new Padding(-20, 2, 2, 2);
        ...
        /// ListItems
        /// </summary>
        public Font ListItemsFont { get; set; } = new Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(238)));
        public float ListItemsFontSize { get; set; } = 8.25F;
        public Size ListItemsSize { get; set; } = new Size(476, 487);
        public Padding ListItemsMargin { get; set; } = new Padding(0, 0, 0, 0);
        public Padding ListItemsPadding { get; set; } = new Padding(1, 1, 1, 0);
